...
/**
 * Helps create CloseableIterables from regular Iterables. This class only exists because interfaces cannot yet have static methods
 * in Java 7. We'll have to wait for Java 8 to remove this class.
 */
