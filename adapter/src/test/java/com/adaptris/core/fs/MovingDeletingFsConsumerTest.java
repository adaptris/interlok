...
public class MovingDeletingFsConsumerTest extends FsConsumerCase
{
	...
	public MovingDeletingFsConsumerTest(java.lang.String testName)
	{
		super(testName);
	}
	...
	{
		final String destinationName = subDir == null ? PROPERTIES.getProperty(BASE_KEY) : PROPERTIES.getProperty(BASE_KEY) + "/" + subDir;
		ConfiguredConsumeDestination dest = threadname != null ? new ConfiguredConsumeDestination(destinationName, null, threadname)
				: new ConfiguredConsumeDestination(destinationName);

		final MovingNonDeletingFsConsumer fs = new MovingNonDeletingFsConsumer(dest);
