...
public class SharedConnectionConfigurationCheckerTest {
  ...
  public void testNoConnections() throws Exception {
    configurationStream = createAdapterConfig(null, null, null, null);
  ...
  public void testSharedNotUsed() throws Exception {
    configurationStream = createAdapterConfig(new NullConnection("SharedNullConnection"), null, null, null);
  ...
  public void testConsumeConnectionNoShared() throws Exception {
    configurationStream = createAdapterConfig(null, new SharedConnection("DoesNotExist"), null, null);
  ...
  public void testProduceConnectionNoShared() throws Exception {
    configurationStream = createAdapterConfig(null, null, new SharedConnection("DoesNotExist"), null);
  ...
  public void testProduceAndConsumeConnectionsExist() throws Exception {
    configurationStream = createAdapterConfig(new NullConnection("SharedNullConnection"), new SharedConnection("SharedNullConnection"), new SharedConnection("SharedNullConnection"), null);
  ...
  public void testServiceConnectionDoesNotExist() throws Exception {
    configurationStream = createAdapterConfig(new NullConnection("SharedNullConnection"), null, null, new SharedConnection("DoesNotExist"));
