...
public class PooledSplitJoinServiceTest {
  ...
  public void testService() throws Exception {
    ...
    // Using an appending message aggregator just means that we double up on the
    // original message...
  ...
  public void testTimeout() throws Exception {
    Assertions.assertThrows(ServiceException.class, () -> {
      ...
      try {
        ...
        // This will be a RuntimeException (from hasNext()?) that wraps a
        // TimeoutException
  ...
  public void testService_DidWorkSuccessfully() throws Exception {
    ...
    service.setSplitter(new LineCountSplitter(1));
    service.setService(asCollection(new WaitService(new TimeInterval(10L, TimeUnit.MILLISECONDS), false),
