...
/**
 * <p>
 * Extension to <code>BaseCase</code> for <code>Service</code>s which provides a method for
 * marshaling sample XML config.
 * </p>
 */
public abstract class ExampleChannelCase extends ExampleConfigGenerator {
  /**
