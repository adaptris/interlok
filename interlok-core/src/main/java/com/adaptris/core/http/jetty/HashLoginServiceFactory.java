 ...
 * <a href="https://wiki.eclipse.org/Jetty/Tutorial/Realms">the eclipse jetty site</a> should always be considered canonical. The
 * HashLoginService is a realm whose authentication and authorization information is stored in a properties file. Each line in the
 * file contains a username, a password, and zero or more role assignments. The format is <pre>
 * {@code 
 ...
 * </ul>
 * <p>
 * If you need to secure the passwords in your properties file then you can follow
 * <a href= "https://www.eclipse.org/jetty/documentation/9.3.x/configuring-security-secure-passwords.html">the jetty
 * documentation</a> to obfuscate/hash the password. <pre>
 * {@code
