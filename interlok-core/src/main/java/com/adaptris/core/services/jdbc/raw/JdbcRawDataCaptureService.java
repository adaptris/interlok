...
*
*/
@JacksonXmlRootElement(localName = "jdbc-raw-data-capture-service")
...
@DisplayOrder(order = {"connection", "statement", "rowsUpdatedMetadataKey", "statementParameters",
"parameterApplicator", "saveReturnedKeys", "saveReturnedKeysColumn", "saveReturnedKeysTable"})
...
getParameterApplicator().applyStatementParameters(msg, insert, getStatementParameters(), getStatement());
