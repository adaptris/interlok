...
public class AddPayloadService extends ServiceImp
{
	 ...
	 *
	 * @param newPayloadEncoding The payload encoding.
	 */
	 ...
	 * {@inheritDoc}.
	 *
	 * @param msg The message to which the payload should be added.
	 */
	@Override
	public void doService(AdaptrisMessage msg) throws ServiceException
	{
		log.info("Attempting to add payload " + newPayloadId + " to message");
		...
		try
		{
			payload = newPayload.extract(message);
		}
		catch (Exception e)
		{
