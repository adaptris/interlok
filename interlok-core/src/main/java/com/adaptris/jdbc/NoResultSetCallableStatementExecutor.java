 ...
 * 
 * 
 * @config no-resultset-callable-statement-executor
 * @author Aaron McGrath
 */
@JacksonXmlRootElement(localName = "no-resultset-callable-statement-executor")
@XStreamAlias("no-resultset-callable-statement-executor")
public class NoResultSetCallableStatementExecutor implements CallableStatementExecutor {
